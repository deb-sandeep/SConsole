sConsoleApp.controller( 'JEEAdvTestResultController', 
                         function( $scope, $http, $location, $window ) {

    // ---------------- Scope variables --------------------------------------
    $scope.$parent.navBarTitle = "JEE Advanced Test Results" ;
    $scope.totalMarks = 0 ;
    $scope.totalScore = 0 ;
    ...
    function initializeController() {
        if( $scope.$parent.overallSection.questions.length == 0 ) {
            $location.path( "/" ) ;
        }
        else {
            computeResult() ;
    ...
    function computeResult() {
        ...
        var questions = $scope.$parent.overallSection.questions ;
        
        for( var i=0; i<questions.length; i++ ) {
            
            var questionEx = questions[i] ;
